...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex gap-7 shadow-[0_1px_15px_gray] fixed z-50 left-[50%] translate-x-[-50%] p-2 px-10 rounded-full bg-[#18181b] ">
        <LinkScroll
          to='home'
          smooth={true}
          duration={1000}
          ...
          spy={true}
        >
        <div className={`${style} + ${activeSection === 'home' ? ' bg-[#3f3f46] rounded-full' : ''}`}>Home</div>
        </LinkScroll>
        ...
        <LinkScroll
          ...
          spy={true}
        >
        <div className={`${style} + ${activeSection === 'benefits' ? ' bg-[#3f3f46] rounded-full' : ''}`}>Why FocusX?</div>
        </LinkScroll>
        ...
        <LinkScroll
          ...
          spy={true}
        >
        <div className={`${style} + ${activeSection === 'process' ? ' bg-[#3f3f46] rounded-full' : ''}`}>The Process</div>
        </LinkScroll>
      </div>

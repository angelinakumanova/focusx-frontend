...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-screen bg-gradient-to-t from-neutral-800 to-neutral-950 p-2 hidden md:flex md:flex-col w-[300px] shrink-0",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden  items-center justify-between bg-neutral-950  w-full"
        )}
        {...props}
      >
